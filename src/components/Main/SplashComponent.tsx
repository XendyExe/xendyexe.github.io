...
const SplashComponent: React.FC = () => {
    ...
    return (
        <div className="splash splash-drop-shadow" style={{ opacity: "90%" }}>
            <motion.img fetchPriority="high" src={frame.src} className="splash-bottom-left-framing splash-framing" animate={blframing} transition={bobTransition} />
            <motion.img fetchPriority="high" src={frame.src} className="splash-top-right-framing splash-framing" animate={trframing} transition={bobTransition} />
            <motion.div className="splash-content">
                <motion.svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 64.44 23.65"
                    width="300px"
                    style={{
                        color: "#fff",
                        stroke: "#fff",
